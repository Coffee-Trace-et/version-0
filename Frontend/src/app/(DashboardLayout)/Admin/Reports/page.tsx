...
const page = () => {
  ...
  return (
    <div className="flex justify-between">
      <div className="w-full  relative flex gap-10 flex-col">
        ...
        <div className="flex flex-wrap w-full gap-8 overflow-hidden overflow-y-scroll max-h-[100dvh]">
          {blog?.reverse().map((items, index) => (
            <div
              key={index}
              className="flex flex-col sm:w-[45%] p-4 border-2 rounded-md gap-4 "
            >
              <div className="flex justify-between items-center">
                ...
                <button
                  className=" bg-red-500 w-[94px] h-[32px] text-white rounded-md hover:bg-red-600"
                  onClick={handleAddPost}
                >
                  Delete
                </button>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#00000057]">
          <div
            className="absolute top-5 right-5 border-2 p-2 text-2xl  rounded-full cursor-pointer"
          ...
          <div className="bg-white rounded-lg p-6 w-96 shadow-lg">
            <div className="flex items-center mb-4">
              <AiOutlineDelete className="text-red-500 text-3xl mr-2" />
